...
/**
 * Allows EntityManager to "auto join into JTA transaction" See:
 * https://community.jboss.org/message/850194
 */
public class JtaEntityManagerProxy implements java.lang.reflect.InvocationHandler {
	...
	public static Object newInstance(EntityManager obj) {
		return Proxy.newProxyInstance(obj.getClass().getClassLoader(), new Class<?>[] { EntityManager.class },
				new JtaEntityManagerProxy(obj));
	}
